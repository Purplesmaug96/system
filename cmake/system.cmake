...
set(WHOA_ANDROID_UNK 9999)
set(WHOA_WII_UNK 9999)
...
elseif(${CMAKE_SYSTEM_NAME} MATCHES "Android")
	set(WHOA_SYSTEM_ANDROID 1)
	add_definitions(-DWHOA_SYSTEM_ANDROID=1)
elseif(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    set(WHOA_SYSTEM_LINUX 1)
    add_definitions(-DWHOA_SYSTEM_LINUX=1)
elseif(${CMAKE_SYSTEM_NAME} MATCHES "NintendoWii")
	set(WHOA_SYSTEM_WII 1)
	add_definitions(-DWHOA_SYSTEM_WII=1)
endif()
...
elseif(${WHOA_SYSTEM_MAC})
    if(${CMAKE_SYSTEM_VERSION} MATCHES "10.8")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_8})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "10.9")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_9})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "10.10")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_10})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "10.11")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_11})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "10.12")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_12})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "10.13")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_13})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "10.14")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_14})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "10.15")
        set(WHOA_SYSTEM_VERSION ${WHOA_MAC_10_15})
    elseif(${CMAKE_SYSTEM_VERSION} MATCHES "11.0")
    ...
    add_definitions(-DWHOA_SYSTEM_VERSION=${WHOA_SYSTEM_VERSION})
elseif(${WHOA_SYSTEM_ANDROID})
	set(WHOA_SYSTEM_VERSION ${WHOA_ANDROID_UNK})
...
elseif(${WHOA_SYSTEM_LINUX})
    ...
    add_definitions(-DWHOA_SYSTEM_VERSION=${WHOA_SYSTEM_VERSION})
elseif(${WHOA_SYSTEM_LINUX})
    set(WHOA_SYSTEM_VERSION ${WHOA_WII_UNK})

    add_definitions(-DWHOA_SYSTEM_VERSION=${WHOA_WII_VERSION})
endif()
